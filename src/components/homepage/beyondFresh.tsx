...
const BeyondFresh = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const params = { page: "home", pageReference: "middle-center","getspecification":1  };
        ...
        <section className="2xl:px-28 xl:px-28 lg:px-15 md:px-5 sm:px-5 xs:px-5 px-3 h-auto  mx-auto pb-5 lg:pb-10">
            <div className="pt-5">
                <div className="flex items-center justify-center lg:justify-between">
                    <h2 className="text-2xl font-bold text-dark sm:text-3xl ">The best of <span
                        className="text-[#0d916d]">Beyondfresh</span></h2>
                ...
                <div className="grid gap-2 2xl:gap-2 xl:gap-2 lg:gap-2 md:gap-2 sm:gap-4 xs:gap-2 grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 2xl:grid-cols-5 mt-5 mx-auto">
